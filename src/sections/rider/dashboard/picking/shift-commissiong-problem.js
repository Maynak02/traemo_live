...
const ShiftCommissioningProblem = ({ setCurrentCommissioningView }) => {
    ...
    const redirect = () => {
        ...
        setCurrentCommissioningView("MAIN");
    };
    ...
    const handleCancelOrder = async () => {
        ...
        try {
            ...
            if (status && data?.ok) {
                ...
                await items.forEach(({ product_id, refunded_quantity }) => {
                    dispatch(
                        updateOrderProductField({
                            product_id,
...
export default ShiftCommissioningProblem;
